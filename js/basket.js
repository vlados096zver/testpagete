...
$(document).on('click', '.product__item .favorites__del', function() {
  $(this).parents('.product__item').remove();
})

$(document).on('click', '.rcatalog__col .favorites__del', function() {
  $(this).parents('.rcatalog__col').remove();
})
