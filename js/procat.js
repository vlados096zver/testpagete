...
function changeStateBuy(btn, active) {
  $(document).on('click', btn, function() {
    ...
    let select = parent.find('.select__wrap');
...
$(document).on('change', '.equipment__wrap .size__select', function(e) {
  ...
  wrap.find('.equipment__btn').addClass('equipment__btn--check').find('span').text(btn.data('end'));
...
$(document).on('change', '.buy .buy__box', function(e) {
  ...
  wrap.find('.buy__btn').addClass('buy__btn--check').find('span').text(btn.data('end'));
